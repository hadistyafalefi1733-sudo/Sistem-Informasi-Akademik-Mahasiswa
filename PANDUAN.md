...
1. Persyaratan
Sebelum menjalankan program, pastikan komputer telah terinstal:
Python versi 3.x
Visual Studio Code atau IDLE Python (opsional)

2. Menjalankan Program
Buka folder proyek.
Jalankan file akademik.py.
Program akan menampilkan menu utama.
Contoh menjalankan melalui terminal:
python akademik.py
